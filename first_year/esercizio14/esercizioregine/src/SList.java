...
public class SList<T> {                    // Scheme-Like Lists of T
    ...
    public static final SList<Integer> lista = new SList<Integer>();
    //public static final SList<String> lista2 = new SList<String>();

    //first è di tipo T
    //il resto della lista è di tipo T
    ...
    public SList( T e, SList<T> tl ) {       // creazione di una lista non vuota:
        // Scheme: cons
        // empty = false;
        first = e; //primo elemento di tipo T
        rest = tl; //resto della lista di tipo T
    }
